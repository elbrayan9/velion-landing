      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-zinc-900/50 rounded-2xl border border-emerald-500/30 overflow-hidden flex flex-col relative"
          >
            <div className="absolute inset-0 bg-emerald-500/5 pointer-events-none" />
            <div className="p-6 border-b border-emerald-500/10 bg-emerald-500/10 flex items-center gap-3 relative z-10">
            ...
            <div className="p-8 space-y-6 flex-1 relative z-10">
              ...
              <div className="flex gap-4">
                <div className="text-emerald-500 font-mono text-sm pt-1">
                  23:47
                </div>
                <div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-emerald-400 font-medium">Venta cerrada.</p>
                  <p className="text-zinc-400">
            ...
            <div className="p-4 bg-emerald-950/30 border-t border-emerald-500/20 text-center relative z-10">
